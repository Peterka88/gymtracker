...
public class WorkoutSetController {
    ...
    public ResponseEntity<WorkoutCreateSetResDTO> createWorkoutSet(
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(workoutSetService.createWorkoutSet(principal.getId(), exerciseSessionId, dto));
    }
    ...
    public ResponseEntity<WorkoutSetResponse> updateWorkoutSet(
        ...
        return ResponseEntity.ok(workoutSetService.updateWorkoutSet(principal.getId(), setId, dto));
    }
